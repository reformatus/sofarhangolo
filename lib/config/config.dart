...
final AppConfig appConfig = AppConfig(
  ...
  gitHubApiRoot: 'https://api.github.com/repos/reformatus/sofarhangolo',
  domain: 'app.sofarhangolo.hu',
  appFeedbackEmail: 'sofarhangolo@fodor.pro',
  homepageRoot: 'https://app.sofarhangolo.hu',
  apiRoot: 'https://app.sofarhangolo.hu/api',
  webappRoot: 'https://app.sofarhangolo.hu/web',
  gitHubRepo: 'https://github.com/reformatus/sofarhangolo/',
